...
Currently:
Validation and Verification Group, Applied Radiation Technology  
...
- Evolutionary algorithms in nuclear engineering  
- Machine learning applications for reactor analysis  
- Activation and radiation transport calculations  
- Monte Carlo methods (MCNP, Serpent2, OpenMC)
...
- Optimization of the cost and efficiency of Mo-99 production in the MARIA reactor  
  Kubinski, W.; Prokopowicz, R.  
  *Nuclear Engineering and Design* 454, 114926 (2026)

- Prediction of the evolution of the nuclear reactor core parameters using artificial neural network  
  Palmi, K.; Kubinski, W.; Darnowski, P.  
  *Annals of Nuclear Energy* 211, 110891 (2025)

- Shannon Entropy Analysis of a Nuclear Fuel Pin Under Deep Burnup  
  Kubiński, W.R.; Ostrowski, J.K.; Fornalski, K.W.  
  *Entropy* 26(12), 1124 (2024)
...
- Probabilistic radwaste characterization: Findings of a multi-method multi-mockup exercise using interpolation-based surrogate efficiencies  
  Laloy, E.; Rogiers, B.; Bielen, A.; Borella, A.; Kubiński, W.; et al.  
  *Annals of Nuclear Energy* 194, 110065 (2023)
...
- Application of genetic algorithms in optimization of SFR nuclear reactor design  
  Żurkowski, W.; Sawicki, P.; Kubiński, W.; Darnowski, P.  
  *Nukleonika* 66 (2021)

- The development of a novel adaptive genetic algorithm for the optimization of fuel cycle length  
  Kubiński, W.; Darnowski, P.; Chęć, K.  
  *Annals of Nuclear Energy* 155, 108153 (2021)

- MARIA reactor irradiation technology capabilities towards advanced applications  
  Migdal, M.; Balcer, E.; Bartosik, Ł.; et al.  
  *Energies* 14(23), 8153 (2021)

- Application of Artificial Neural Network and Particle Swarm Optimization in determining selected parameters of the nuclear reactor core  
...
- *Uncertainty of radioactive waste characterization using calorimetry combined with gamma spectrometry — numerical case study* (Poster)  
  Nuclear Energy for New Europe (NENE), Portorož, Slovenia (September 2020)

- *Optimization of BEAVRS PWR Loading Pattern Using a Novel Genetic Algorithm Based on Population Variance Control*  
  Nuclear Energy for New Europe (NENE), Portorož, Slovenia (September 2020)

- *Calorimetric Non-Destructive Assay of Large Volume and Heterogeneous Radioactive Waste Drums*  
  ANIMMA Conference, Portorož, Slovenia (June 2019)
...
- PUMA (*antiProton Unstable Matter Annihilation*, ERC, grant no. 726276), 2019  
